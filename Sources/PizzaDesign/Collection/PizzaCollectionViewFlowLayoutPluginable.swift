...
open class PizzaCollectionViewFlowLayoutPluginableLayoutAttributes: UICollectionViewLayoutAttributes {
...
public enum PizzaCollectionViewFlowLayoutPluginableAlignment {
    case lineStart, lineCenter, lineEnd
}

open class PizzaCollectionViewFlowLayoutPluginable: UICollectionViewFlowLayout {

    // MARK: - Nested Types

    public typealias LayoutAttributes = PizzaCollectionViewFlowLayoutPluginableLayoutAttributes
    public typealias Alignment = PizzaCollectionViewFlowLayoutPluginableAlignment

    // MARK: - Private Properties

    private let alignment: Alignment?
    private let plugins: [PizzaCollectionViewFlowLayoutPlugin]

    // MARK: - Initialization

    public init(
        alignment: Alignment?, // TODO: support vertical
        plugins: [PizzaCollectionViewFlowLayoutPlugin]
    ) {
