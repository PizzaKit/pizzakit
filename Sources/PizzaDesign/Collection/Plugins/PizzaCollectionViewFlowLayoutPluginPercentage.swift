...
extension PizzaCollectionViewFlowLayoutPluginableLayoutAttributes: PizzaCollectionViewFlowLayoutPluginPercentageLayoutAttributes {

    public var collectionVisibility: CGFloat? {
        get {
    ...
    public var idealFrameVisibility: CGFloat? {
        get {
            dictWithProperties[#fileID + "_" + #function] as? CGFloat
        }
        set {
    ...
    public var idealFrameAndCollectionVisibility: CGFloat? {
        get {
            dictWithProperties[#fileID + "_" + #function] as? CGFloat
        }
        set {
...
public protocol PizzaCollectionViewFlowLayoutPluginPercentageLayoutAttributes: UICollectionViewLayoutAttributes {
    var collectionVisibility: CGFloat? { get set }
    var idealFrameVisibility: CGFloat? { get set }
    var idealFrameAndCollectionVisibility: CGFloat? { get set }
}

open class PizzaCollectionViewFlowLayoutPluginPercentage: PizzaCollectionViewFlowLayoutPlugin {

    // MARK: - Nested Types

    private struct Context {
        let alignment: PizzaCollectionViewFlowLayoutPluginableAlignment?
    ...
    // MARK: - PizzaCollectionViewFlowLayoutPlugin
