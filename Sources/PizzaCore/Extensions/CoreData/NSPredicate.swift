...
public func && <TP1: TypedPredicateProtocol, TP2: TypedPredicateProtocol>(
    p1: TP1,
    p2: TP2
...
public func === <S: Sequence, R, K: KeyPath<R, S.Element>>(
    kp: K,
    values: S
) -> ComparisonPredicate<R> where S.Element: Equatable {
